...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  allTechnologies: TechIcon[] = [
    ...
    },
    {
      name: 'Node.js', 
      color: '#339933', 
      path: 'M12 1.85c-.7 0-1.4.1-2 .4L3.8 4.7c-1.2.7-2 2-2 3.4v7.8c0 1.4.8 2.7 2 3.4l6.2 3.5c1.2.7 2.8.7 4 0l6.2-3.5c1.2-.7 2-2 2-3.4V8.1c0-1.4-.8-2.7-2-3.4L14 1.25c-.6-.3-1.3-.4-2-.4z',
      icon: ''
    },
    {
      name: 'MongoDB', 
  ...
  async sendMessage(): Promise<void> {
    if (this.contactForm.valid && !this.isSubmitting) {
      ...
      try {
        ...
        // Show success message (you can implement SweetAlert2 here)
