# AzottoDev — Style Reference
> Sunlit workspace with scattered confetti

**Theme:** light

AzottoDev uses a warm, editorial-meets-product language: off-white canvas with a soft cream wash, generous breathing room, and dark near-black type that reads like printed ink. The visual signature is a multi-hue pastel palette — petal pink, mint green, canary yellow, violet, cyan — used as flat card and section backgrounds rather than decoration, creating a 'color-coded' taxonomy of product areas. A vivid azoto-blue accent grounds the brand identity against a charcoal secondary surface (#272625). Type is set in a geometric grotesque (Labil Grotesk) with aggressive negative tracking on display sizes, where weight 900 84px uppercase headlines act as poster titles and weight 400 44–56px headlines feel calm and confident. The overall mood is light, airy, and approachable — a productivity tool that doesn't feel like enterprise software.

## Tokens — Colors

| Name | Value | Token | Role |
|------|-------|-------|------|
| Azoto Blue | `radial-gradient(386.06% 162.79% at 3.76985% -12.1005%, rgb(56,232,255) 0%, rgb(225,249,255) 31.14%, rgb(84,215,255) 81.98%), rgb(0,164,230) 100%` | `--color-azoto-blue` | Brand accent, hero gradient origin, marketing highlights — vivid warm blue that gives the brand its identity; Hero background gradient — radial wash from Azoto Blue through cream to violet |
...
- Don't use color for decoration on dark sections — reserve Azoto Blue for hero gradient origins and brand moments
...
- Accent (brand): #09c7f7 (Azoto Blue)
- primary action: no distinct CTA color

**Example Component Prompts**

1. Hero headline: "84px Labil Grotesk Variable weight 900, uppercase, #111111, letter-spacing -2.52px, line-height 0.8. Place over a radial gradient background from #09c7f7 through #ffeed8 to #d0b2ff."
...
- **Raycast** — Similar playful brand accent (blue) against a clean off-white canvas with geometric grotesque type at restrained weights
...
:root {
  /* Colors */
  --color-azoto-blue: #09c7f7;
  --gradient-azoto-blue: radial-gradient(386.06% 162.79% at 3.76985% -12.1005%, rgb(56,232,255) 0%, rgb(225,249,255) 31.14%, rgb(84,215,255) 81.98%), rgb(0,164,230) 100%;
